 ...
 * @author Dren
 */
public class StreamingSukses extends javax.swing.JDialog {
    ...
    /**
     * Creates new form StreamingSukses
     */
    public StreamingSukses(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Streaming Controller");
        ...
        jLabel4.setText("STREAMING WAS  SUCCESSFULLY REGISTERED!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StreamingSukses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                StreamingSukses dialog = new StreamingSukses(new javax.swing.JFrame(), true);
