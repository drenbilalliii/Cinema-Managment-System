 ...
 * @author Dren
 */
public class PagesaMeSukses extends javax.swing.JDialog {
    ...
    /**
     * Creates new form PagesaMeSukses
     */
    public PagesaMeSukses(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Payment Controller");
        ...
        jLabel4.setText("PAYMENT WAS  SUCCESSFULLY REGISTERED!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PagesaMeSukses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PagesaMeSukses dialog = new PagesaMeSukses(new javax.swing.JFrame(), true);
