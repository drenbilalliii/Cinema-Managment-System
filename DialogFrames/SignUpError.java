 ...
 * @author Dren
 */
public class SignUpError extends javax.swing.JDialog {
     ...
     */
    public SignUpError(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
 Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignUpError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SignUpError dialog = new SignUpError(new javax.swing.JFrame(), true);
